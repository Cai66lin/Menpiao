...
public class DocxTemplateToPdfImpl {
    ...
    public static void generateDocxAndPdf(AdmissionTicket admissionTicket) {
        ...
        params.put("${oid}", admissionTicket.getOrderID());
        ...
        params.put("${price}", admissionTicket.getPrice());
        ...
        try (InputStream inputStream = DocxTemplateToPdfImpl.class.getClassLoader().getResourceAsStream(resource)) {
        	FileOutputStream os = new FileOutputStream(new File(admissionTicket.getOrderID()+".pdf"));
            ...
            doc.write(new FileOutputStream(new File(admissionTicket.getOrderID()+".docx")));
